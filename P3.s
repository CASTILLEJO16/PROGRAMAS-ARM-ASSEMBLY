...
namespace RestaNumeros
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Resultado de la resta: " + Itoa(resultado));
        }
...
// Descripción: Programa en ARM64 Assembly para RaspbianOS que resta dos números.
// Este programa solicita dos números del usuario, realiza la resta y muestra el resultado.
